...
/*! Lights rings in the current setup at full saturation for App Store
    screenshots. The 0/1 pattern repeats across the rings from the centre
    outward; nil or empty falls back to the classic on-off alternation. */
