...
#ifndef _HEAVY_PHASERING_H_
#define _HEAVY_PHASERING_H_
 ...
 */
HeavyContextInterface *hv_PhaseRing_new(double sampleRate);
 ...
 */
HeavyContextInterface *hv_PhaseRing_new_with_options(double sampleRate, int poolKb, int inQueueKb, int outQueueKb);

/**
 * Free the patch instance.
 */
void hv_PhaseRing_free(HeavyContextInterface *instance);
