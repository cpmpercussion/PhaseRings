...
Final copy-paste text for every ASC field (subtitle, keywords, promotional
text, description, what's-new, review notes, URLs) lives in
**`appstore-metadata-v3.0.md`** — character limits checked.

Rationale worth remembering: App Store search indexes only the **name**,
**subtitle**, and **keywords field** — not the description — so "auv3" sits in
the subtitle and keywords. Third-party app names (AUM, GarageBand) stay out of
keywords (guideline 2.3.7) but are fine in the description as compatible
hosts.
